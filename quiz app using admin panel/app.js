...
function appendResult() {
    ...
    for (var i = 0; i < questions.length; i++) {
        if (answers[i]) {
            divBody += "<td><img style='width:20px' src='accept.png'></td>"
            correctQuestions++
        }
        else divBody += "<td><img style='width:20px' src='close.png'></td>"
    }
    divBody += "</tbody></table>"
...
function loginButton() {
    ...
    if (username.value === "Priti" && password.value === "Pritirani@0312") {
